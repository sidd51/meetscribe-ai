//This page is almost identical to ResultsPage 
// — it just always fetches from the API since it's accessed from the history list, not from a fresh upload.
...
${meeting.transcript}
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <Link
        to="/history"
        className="text-center py-2.5 text-sm border border-gray-200 rounded-xl text-gray-600 hover:bg-gray-50 transition-colors"
      >
